<template>
  <view>
      ...
      <view class="section-content">
        <view class="item">
          <view class="left">
            ...
            <text class="item-desc">时段收费（{{ baseMileagePrice }}元{{ baseMileage }}公里，超出每公里{{
                exceedMileagePrice
              }}元）
            </text>
          </view>
      ...
      <view class="section-content">
        <view class="remark-container">
          <view class="remark-rate">
            ...
            <view class="rate">
              <u-rate :count="customerComment.count" v-model="customerComment.value" disabled="true"
    ...
    <u-popup v-model="comment.showComment" mode="center" border-radius="14" width="550rpx" height="580rpx">
      ...
      <u-input v-model="comment.remark" type="textarea" :border="false" :clearable="false" placeholder="说说哪里好,其他顾客想知道~"
